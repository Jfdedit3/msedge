...
public sealed class BrowserForm : Form
{
    ...
    private readonly ToolStripButton downloadsButton;
    private readonly ToolStripButton historyButton;
    private readonly ToolStripButton extensionsButton;
    ...
    public BrowserForm(string dataRoot)
    {
        this.dataRoot = dataRoot;
        historyStore = new HistoryStore(dataRoot);

        Text = "Chromium Browser Plus";
        Width = 1400;
        Height = 900;
        ...
        newTabButton = new ToolStripButton("New Tab");
        closeTabButton = new ToolStripButton("Close Tab");
        devToolsButton = new ToolStripButton("DevTools");
        downloadsButton = new ToolStripButton("Downloads");
        historyButton = new ToolStripButton("History");
        extensionsButton = new ToolStripButton("Extensions");
        addressBar = new ToolStripTextBox { AutoSize = false, Width = 620 };
        ...
        downloadsButton.Click += (_, _) => OpenDownloadsPage();
        historyButton.Click += (_, _) => OpenHistoryPage();
        extensionsButton.Click += (_, _) => OpenExtensionsPage();
        ...
        toolStrip.Items.Add(downloadsButton);
        toolStrip.Items.Add(historyButton);
        toolStrip.Items.Add(extensionsButton);
    ...
    {
        AddTab(PageBuilder.BuildDownloadsPage());
    }

    private void OpenHistoryPage()
    {
        AddTab(PageBuilder.BuildHistoryPage(historyStore.GetAll()));
    }

    private void OpenExtensionsPage()
    {
        AddTab(PageBuilder.BuildExtensionsPage(dataRoot));
    }
    ...
    private void SyncUi()
    {
        ...
        refreshButton.Text = browser.IsLoading ? "Stop" : "Refresh";
    }
